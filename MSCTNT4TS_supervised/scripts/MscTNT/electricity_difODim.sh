...
model_id_name=Electricity_smallerDim2
data_name=custom
...
# for outer_dim in 20 40
for outer_dim in 60 80
do
# for inner_dim in 4 8 12 16 20 40
for inner_dim in 4
do
    ...
    python -u run_longExp.py \
      ...
      --model_id $model_id_name"_"od$outer_dim"_"id$inner_dim"_"opl$patch_len"_"ipl$subpatch_len"_"oh$outer_n_heads"_"ih$inner_n_heads \
